...
const Header = ({auth, setAuth}) => {
    ...
    return(<div className="header">
        <div className="header-top">
            <div className="header-top-btn" onClick={openSideMenu}>
                <i className="xi-bars"></i>
            </div>
            <div className="header-top-login" onClick={moveToLogin}>
